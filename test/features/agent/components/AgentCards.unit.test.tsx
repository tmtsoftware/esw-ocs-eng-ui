...
describe('Agents Grid View', () => {
  ...
  // })
  // it('should render multiple agents', async (done) => {
  //   when(smService.getAgentStatus()).thenResolve({
  //     _type: 'Success',
  ...
  //   done()
  // })
  // it('should render agents when getAgentStatus returns orphan seqComps', async (done) => {
  //   when(smService.getAgentStatus()).thenResolve({
  //     _type: 'Success',
  //     agentStatus: [agentStatus],
  //     seqCompsWithoutAgent: [
  ...
  //   done()
  // })
  // it('should render empty agents when getAgentStatus returns locationServiceError', async (done) => {
  //   when(smService.getAgentStatus()).thenResolve({
  ...
  //   done()
  // })
  // it('should render empty agents when getAgentStatus returns unhandled error', async (done) => {
  //   when(smService.getAgentStatus()).thenResolve({
  //     _type: 'Unhandled',
